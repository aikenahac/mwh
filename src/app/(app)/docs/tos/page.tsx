    ...
    <div className="container mx-auto py-8 px-4 max-w-4xl overflow-x-hidden">
      <Card>
        ...
        <section className="mb-8">
          ...
          <p>
            All content, design, and software related to Mess With Humanity are
            owned or licensed by Aerio, Aiken Tine Ahac s.p. You retain
            ownership of any content you create or upload but grant us a limited
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            To the fullest extent permitted by law, Aerio, Aiken Tine Ahac s.p.
            is not liable for:
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              These Terms are governed by the laws of Slovenia and the European
              Union.
            </li>
